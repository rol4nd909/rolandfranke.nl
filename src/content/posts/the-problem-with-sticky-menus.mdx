...
You could add an inner scroll bar to the menu. But <Link as='a' href="https://baymard.com/blog/inline-scroll-areas" target="blank">multiple scroll bars are hard to use</Link>.
...
This is because <Link as='a' href="https://alistapart.com/article/designing-safer-web-animation-for-motion-sensitivity/" target="blank">animation can cause dizziness, nausea, headaches and more</Link>.
