...
So instead of asking <i>“what does this do?”</i>, you can start asking <i>“does this describe what I mean?”</i>.
...
It behaves like a `<div>`, but with meaning attached. It tells user agents: <i>this section is for search</i>.
