...
You could add an inner scroll bar to the menu. But [multiple scroll bars are hard to use](https://baymard.com/blog/inline-scroll-areas).
...
This is because [animation can cause dizziness, nausea, headaches and more](https://alistapart.com/article/designing-safer-web-animation-for-motion-sensitivity/).  
