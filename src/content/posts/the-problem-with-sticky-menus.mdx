...
Designers use sticky menus (menus that stick to the edge of the viewport) to make them easy to access on long pages. But this fancy pattern hurts UX far more than it improves it.
Here's why:
...
You could add an inner scroll bar to the menu. But <Link href="https://baymard.com/blog/inline-scroll-areas">multiple scroll bars are hard to use</Link>.
...
This is because scrolling up too much reveals the menu when it's not wanted.

And scrolling down a bit by accident will hide it when it is wanted.

Good design doesn't take control away.

### Problem #3: They cause dizziness and nausea

This is because <Link href="https://alistapart.com/article/designing-safer-web-animation-for-motion-sensitivity/">animation can cause dizziness, nausea, headaches and more</Link>.
